    ...
    <section className="py-8 md:py-10 bg-white relative overflow-hidden border-t border-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-6">
          <h2 className="text-xs sm:text-sm font-bold text-gray-400 tracking-[0.2em] uppercase">
            Trusted by 250+ Ambitious Brands &amp; Global Enterprises
          </h2>
        </div>
        ...
        <div className="relative flex overflow-hidden group">
          ...
          <div className="pointer-events-none absolute top-0 left-0 h-full w-24 sm:w-32 bg-gradient-to-r from-white to-transparent z-10" />
          <div className="pointer-events-none absolute top-0 right-0 h-full w-24 sm:w-32 bg-gradient-to-l from-white to-transparent z-10" />
          ...
          <div className="animate-marquee hover:[animation-play-state:paused] flex items-center gap-12 sm:gap-16 min-w-max">
            {[...clientLogos, ...clientLogos, ...clientLogos].map((client, index) => (
              <div
                key={index}
                className="flex-none px-6 flex justify-center items-center hover:scale-105 transition-transform duration-300"
                title={client.name}
              >
                <Image
                  src={client.src}
