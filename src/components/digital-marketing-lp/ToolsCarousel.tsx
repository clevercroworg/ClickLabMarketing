...
const toolsBottom = [
  ...
  { name: "Shopify Plus", icon: Smartphone, color: "text-green-600" },
  { name: "ActiveCampaign", icon: Zap, color: "text-blue-500" },
  { name: "Hotjar", icon: Megaphone, color: "text-red-500" },
];

export function ToolsCarousel() {
  return (
    <section id="tools" className="py-12 sm:py-16 bg-white relative overflow-hidden border-t border-slate-100">
      <div className="max-w-4xl mx-auto px-4 text-center mb-8">
        ...
        <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">
          Advertising &amp; Analytics Tech Stack
        </h2>
      </div>
          ...
          {[...toolsTop, ...toolsTop, ...toolsTop].map((tool, idx) => {
            ...
            return (
              <div key={idx} className="flex-none px-2.5 sm:px-3">
                <div className="h-12 sm:h-14 px-5 sm:px-7 bg-white rounded-full flex items-center gap-3 border border-slate-200 shadow-xs hover:shadow-md transition-all">
