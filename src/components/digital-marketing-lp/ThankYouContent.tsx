...
export function ThankYouContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#080f1e] via-[#0c1a32] to-[#0f172a] text-white flex flex-col justify-between selection:bg-blue-600 selection:text-white font-sans">
      
      {/* Top Header Navigation */}
      <header className="border-b border-slate-800/80 bg-[#080f1e]/90 backdrop-blur-md py-4 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/digital-marketing" className="flex items-center gap-2">
            <Image
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12 sm:py-20 text-center flex flex-col items-center justify-center">
        ...
        <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight mb-4 max-w-2xl">
          Thank You! Your Growth Audit Is Being Prepared.
        </h1>

        <p className="text-sm sm:text-lg text-slate-300 max-w-xl mx-auto leading-relaxed mb-10 font-normal">
          Our senior performance marketing strategist is preparing your custom competitive audit and will contact your team within <strong className="text-cyan-300 font-bold">2 business hours</strong>.
        </p>
        ...
        <div className="w-full bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl mb-10 text-left backdrop-blur-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-5">
              ...
              <h4 className="text-white font-black text-sm mb-1">Ad &amp; Funnel Audit</h4>
              <p className="text-xs text-slate-300 leading-relaxed">
                We inspect search intent, negative keywords, pixel attribution health, and landing page conversion bottlenecks.
              </p>
            </div>
            ...
            <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-5">
              ...
              <h4 className="text-white font-black text-sm mb-1">Strategy Consultation</h4>
              <p className="text-xs text-slate-300 leading-relaxed">
                Our growth director contacts you to walk through high-impact quick wins and budget reallocation opportunities.
              </p>
            </div>
            ...
            <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-5">
              ...
              <h4 className="text-white font-black text-sm mb-1">90-Day Scaling Blueprint</h4>
              <p className="text-xs text-slate-300 leading-relaxed">
                We deliver a concrete roadmap with target ROAS, CPA goals, creative testing schedules, and revenue projections.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md">
          <a
            href="tel:2164088962"
            className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-black text-sm sm:text-base px-6 py-4 rounded-2xl shadow-xl shadow-blue-600/40 border border-blue-400/30 transition-all text-center group cursor-pointer"
          >
            <PhoneCall className="w-5 h-5 text-white group-hover:rotate-12 transition-transform" />
            <span>Need Immediate Answers? Call (216) 408-8962</span>
          </a>
      ...
      <footer className="border-t border-slate-800/80 py-6 px-4 text-center text-xs text-slate-400 font-medium">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            <span className="text-slate-400">Boca Raton, Florida</span>
            <span>•</span>
